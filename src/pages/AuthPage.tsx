    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-rose-50 dark:from-gray-950 dark:via-purple-950 dark:to-rose-950 p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="glass rounded-3xl p-8 shadow-2xl animate-slide-up" style={{ animationDelay: '0.1s' }}>
          <h2 className="text-xl font-semibold text-center mb-2">欢迎回来</h2>
          <p className="text-muted-foreground text-sm text-center mb-8">
            使用 Google 账号快速登录，开始你的每日穿搭之旅
          </p>
          ...
          <Button
            ...
            disabled={loading}
            className="w-full h-12 text-base bg-white hover:bg-gray-50 text-gray-800 border border-gray-200 shadow-md flex items-center justify-center gap-3 transition-all"
          >
            {loading ? (
